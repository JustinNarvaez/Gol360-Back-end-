...
public class AuthServiceImpl implements IAuthService {
    ...
    public AuthResponseDTO register(RegisterRequestDTO dto) {
        ...
        throw new RuntimeException("Tipo de usuario no valido para registro");
    }
    ...
    public String logout() {
        // Cuando se implemente JWT, aquí se invalidará el token
        return "Sesion cerrada exitosamente";
    }

    // Helper: guarda las preferencias del usuario recién registrado
